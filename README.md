...
[`mango-waybar`](https://codeberg.org/theblackdon/mango-waybar). Version 1.0.4 is a Qt 6/C++ app that keeps the emoji catalog and recent-history workflow, and
...
- Hover over an emoji to see its name in a tooltip.
